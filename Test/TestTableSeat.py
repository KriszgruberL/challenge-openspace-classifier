...
class TestTable(unittest.TestCase):
    ...
    def testHasFreeSpot(self):
        ...
        self.assertTrue(self.table.hasFreeSpot())  # Should still have free spots after assigning one seat

        self.table.assignSeat("Bob")
        self.table.assignSeat("Charlie")
        self.table.assignSeat("Dave")
        self.assertFalse(self.table.hasFreeSpot())  # Should have 4 people seated and no more space
    ...
    def testGetLeftCapacity(self):
        ...
        self.assertEqual(self.table.getLeftCapacity(), 4)
        ...
        self.assertNotEqual(self.table.getLeftCapacity(), 4)
